/**
 * PASSE I v4 - Siretisation via Firecrawl Search (Google)
 * Corrections v3:
...
function computeScoreI(candidates, validations, gbRec) {
  ...
  return {
    ...
    methode: 'passe_I_firecrawl_v4', denomination: bestMatch.validation.denomination,
...
async function main() {
  ...
  const outputFile = process.argv[3] || '/home/netit972/siretisation_v16_firecrawl.json';
