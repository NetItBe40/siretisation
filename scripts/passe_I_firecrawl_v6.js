/**
 * PASSE I v6 - Siretisation via Firecrawl Search (Google)
 * Corrections v3:
...
function firecrawlSearch(query) {
  return new Promise((resolve, reject) => {
    const body = JSON.stringify({ query, limit: 5, lang: "fr", country: "FR", location: "France" });
    const opts = {
...
function computeScoreI(candidates, validations, gbRec) {
  ...
  return {
    ...
    methode: 'passe_I_firecrawl_v6', denomination: bestMatch.validation.denomination,
...
async function main() {
  ...
  console.log('=== PASSE I v6 - FIRECRAWL SEARCH ===');
