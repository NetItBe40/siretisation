/**
 * PASSE I v5 - Siretisation via Firecrawl Search (Google)
 * Corrections v3:
...
function computeScoreI(candidates, validations, gbRec) {
  ...
  return {
    ...
    methode: 'passe_I_firecrawl_v5', denomination: bestMatch.validation.denomination,
...
async function main() {
  ...
  const outputFile = process.argv[3] || '/home/netit972/siretisation_v17_firecrawl.json';
  const maxRecords = parseInt(process.argv[4]) || 999;

  console.log('=== PASSE I v5 - FIRECRAWL SEARCH ===');
